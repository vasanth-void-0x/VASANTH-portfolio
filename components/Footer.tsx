...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-neon/10 px-6 py-10">
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-6 sm:flex-row sm:justify-between">
