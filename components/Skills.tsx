...
function FloatingVisual({ card }: { card: SkillCard }) {
  return (
    <div
      className="absolute -top-8 left-5 z-20 flex h-20 w-24 items-center justify-center"
      aria-hidden="true"
    >
      <Image
        src={card.image}
        ...
        height={360}
        sizes="96px"
        className="h-20 w-24 object-contain drop-shadow-[0_0_7px_rgba(57,255,140,0.22)]"
      />
    </div>
  );
}
